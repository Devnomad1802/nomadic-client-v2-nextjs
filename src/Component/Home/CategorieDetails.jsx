          ...
          <>
            <div className="empty">
              <svg className="empty-illus" viewBox="0 0 160 140" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="#C8462A" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="80" cy="58" r="34" />
                  <circle cx="80" cy="58" r="4" fill="#C8462A" stroke="none" />
                  <polygon points="80,32 72,58 80,58" fill="#C8462A" stroke="none" />
                  <polygon points="80,84 88,58 80,58" fill="#E8C4B8" stroke="none" />
                </g>
                <text x="80" y="24" textAnchor="middle" fontFamily="Inter,sans-serif" fontSize="11" fontWeight="800" fill="#C8462A">N</text>
                <path d="M28 118 q30 -16 52 -4 q24 13 52 -6" fill="none" stroke="#857C6C" strokeWidth="2.5" strokeDasharray="3,7" strokeLinecap="round" />
                <circle cx="28" cy="118" r="4" fill="#857C6C" />
                <path d="M132 108 q9 0 9 9 q0 8 -9 16 q-9 -8 -9 -16 q0 -9 9 -9Z" fill="none" stroke="#C8462A" strokeWidth="2.6" />
                <circle cx="132" cy="117" r="3" fill="#C8462A" />
              </svg>
