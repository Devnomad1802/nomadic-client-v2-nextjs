...
const css = `
.nt-profile{--bg:#FFFFFF;--line:#E1DACE;--line-soft:#EFE7DA;--accent:#C8462A;--accent2:#D9714F;--ink:#1E1C18;--muted:#6B6355;--muted2:#857C6C;--green:#2E6E4E;--badge:#F4D8CE;font-family:system-ui,-apple-system,'Segoe UI',sans-serif;color:var(--ink);padding:clamp(20px,4vw,52px) clamp(16px,4vw,52px);box-sizing:border-box}
.nt-profile *{box-sizing:border-box}
.nt-toast{position:fixed;top:18px;left:50%;transform:translateX(-50%);z-index:1300;background:var(--ink);color:#FBF0EC;padding:11px 20px;border-radius:12px;font-size:14px;font-weight:600;box-shadow:0 10px 30px -10px rgba(0,0,0,.4)}
...
.nt-av-fallback{width:100%;height:100%;border-radius:50%;background:linear-gradient(145deg,var(--accent2),var(--accent));display:flex;align-items:center;justify-content:center;font-weight:700;font-size:32px;color:#FBF0EC}
...
.nt-sel-caret{position:absolute;right:15px;top:50%;transform:translateY(-50%);color:#A79D8C;pointer-events:none;font-size:12px}
...
.nt-cta:hover{background:#A63A22}
...
.nt-ghost{padding:12px 22px;font-size:14px;font-weight:700;color:#33302A;background:transparent;border:1.5px solid #CBC2B3;border-radius:11px;cursor:pointer}
...
.nt-pill-green{font-size:11px;font-weight:700;color:#2E6E4E;background:#E6F0EA;padding:3px 9px;border-radius:99px;text-transform:uppercase;letter-spacing:.04em}
...
.nt-switch{flex-shrink:0;width:46px;height:26px;border-radius:99px;background:#CBC2B3;position:relative;transition:background .18s}
...
.nt-danger{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:18px 20px;border:1px solid #E8C9C0;background:#F7E5E2;border-radius:14px;margin-top:6px}
...
.nt-danger-btn{flex-shrink:0;padding:12px 22px;font-size:14px;font-weight:700;color:#B23A2E;background:transparent;border:1.5px solid #D88B7C;border-radius:11px;cursor:pointer}
.nt-danger-btn:hover{background:#B23A2E;color:#fff;border-color:#B23A2E}
...
.nt-stat.ok{background:#E6F0EA;color:#2E6E4E}
...
.nt-green{color:#2E6E4E;font-weight:600}
...
.nt-card-ph{width:100%;height:100%;background:linear-gradient(135deg,#E9DFCF,#CBC2B3)}
...
.nt-rv-ph{background:linear-gradient(135deg,#E9DFCF,#CBC2B3)}
...
.nt-rv-text{margin:8px 0 0;font-size:14px;line-height:1.55;color:var(--text,#4E483D)}
...
.nt-star{background:none;border:none;padding:0;color:#CBC2B3;line-height:1}
.nt-star.on{color:#C08A2D}
