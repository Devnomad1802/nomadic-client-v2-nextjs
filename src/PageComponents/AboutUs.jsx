    ...
    <div className="v2-page">
            ...
            <div key={ch.id} onClick={() => scrollToChapter(ch.id)} style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }}>
              <span
                ...
                style={{
                  ...
                  height: 9,
                  borderRadius: "50%",
                  background: isActive ? "#CF4A2C" : "rgba(26, 19, 13, 0.25)",
      ...
      <section id="v2-1" style={{ position: "relative", minHeight: "calc(100vh - 80px)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: "#1a130d" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 960, padding: "40px 24px", textAlign: "center", margin: "auto" }}>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "8px 18px", borderRadius: 99, border: "1px solid rgba(244,238,228,.24)", font: "700 11px/1 var(--inter)", letterSpacing: ".16em", textTransform: "uppercase", color: "#D4D4D8" }}>
            Our story
          </span>
          <h1 className="v2-font-heading" style={{ margin: "26px 0 0", fontWeight: 700, fontSize: "clamp(32px, 4.5vw, 56px)", lineHeight: 1.08, letterSpacing: "-.03em", color: "#FAFAFA" }}>
            More than travel.<br />
            <span style={{ color: "#CF4A2C" }}>A story about meaningful experiences.</span>
          </h1>
          <p style={{ margin: "26px auto 0", maxWidth: 640, font: "400 clamp(16px,2vw,19px)/1.65 var(--inter)", color: "#D4D4D8" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap", marginTop: 36 }}>
            ...
            <button type="button" className="v2-ghost" onClick={() => navigate("/hosts")} style={{ padding: "15px 30px", font: "700 15px/1 var(--inter)", color: "#FAFAFA", background: "transparent", border: "1px solid rgba(244,238,228,.32)", borderRadius: 12, cursor: "pointer" }}>
              Meet our hosts
            </button>
          </div>
        </div>
      ...
      {/* ===== 2 · OUR STORY ===== */}
      <section id="v2-2" style={{ background: "#FAFAFA", padding: "clamp(70px,9vw,120px) clamp(20px,5vw,60px)" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", textAlign: "left" }}>
          ...
          <div style={{ maxWidth: 860, marginBottom: 48, textAlign: "left" }}>
            <div className="v2-font-heading" style={{ fontWeight: 800, fontSize: "clamp(64px,10vw,110px)", lineHeight: 0.85, color: "#E4E4E7", letterSpacing: "-.03em" }}>01</div>
            <div style={{ font: "700 12px/1 var(--inter)", letterSpacing: ".18em", textTransform: "uppercase", color: "#CF4A2C", marginTop: 12 }}>Our story</div>
            <h2 className="v2-font-heading" style={{ margin: "12px 0 0", fontWeight: 700, fontSize: "clamp(32px,4.8vw,52px)", lineHeight: 1.08, letterSpacing: "-.02em", color: "#18181B" }}>
          ...
          <div className="v2-split" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(30px,5vw,64px)", alignItems: "center" }}>
            ...
            {/* RIGHT SIDE: Text */}
            <div style={{ display: "flex", flexDirection: "column", gap: 16, font: "400 16px/1.75 var(--inter)", color: "#3F3F46" }}>
              ...
              <p style={{ margin: 0 }}>We started by organising community trips for small groups of explorers who wanted something beyond traditional tourism. Those journeys taught us an important lesson — people weren&apos;t looking for another package. They were searching for <strong style={{ color: "#27272A", fontWeight: 600 }}>authentic experiences.</strong></p>
              ...
              <p className="v2-font-heading" style={{ margin: 0, fontWeight: 600, fontSize: 18, color: "#18181B" }}>That realisation became Nomadic Townies.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{ position: "relative", maxWidth: 940, margin: "0 auto", textAlign: "left" }}>
          ...
          <div style={{ marginTop: 38, display: "flex", flexDirection: "column", gap: 0 }}>
            ...
            <p className="v2-font-heading" style={{ margin: "24px 0 0", fontWeight: 700, fontSize: "clamp(24px,3.4vw,36px)", lineHeight: 1.25, letterSpacing: "-.015em", color: "#FFFFFF", maxWidth: 840 }}>
              We wanted to build a place where travellers discover <span style={{ color: "#CF4A2C" }}>people before destinations</span> — where hosts become storytellers, and every journey creates genuine connection.
            </p>
      ...
      <section id="v2-4" style={{ background: "#EFE7DA", padding: "clamp(70px,9vw,120px) clamp(20px,5vw,60px)" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", textAlign: "left" }}>
          <div style={{ maxWidth: 860, marginBottom: 48, textAlign: "left" }}>
            <div className="v2-font-heading" style={{ fontWeight: 800, fontSize: "clamp(64px,10vw,110px)", lineHeight: 0.85, color: "#E4E4E7", letterSpacing: "-.03em" }}>03</div>
            ...
            <p style={{ margin: "16px 0 0", font: "400 15px/1.65 var(--inter)", color: "#52525B", maxWidth: 780 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
            {stepsData.map((st) => (
              <div key={st.n} className="v2-card" style={{ background: "#FFFFFF", border: "1px solid #E4E4E7", borderRadius: 18, padding: "24px 22px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <span className="v2-font-heading" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 34, height: 34, borderRadius: 10, background: "#18181B", color: "#FAFAFA", fontWeight: 700, fontSize: 14, textAlign: "center", lineHeight: "34px", flexShrink: 0 }}>
                    {st.n}
                  </span>
                  <span style={{ color: "#CF4A2C" }}>{st.icon}</span>
                </div>
                <h3 className="v2-font-heading" style={{ margin: "16px 0 0", fontWeight: 700, fontSize: 15.5, letterSpacing: "-.01em", color: "#18181B" }}>{st.title}</h3>
                <p style={{ margin: "7px 0 0", font: "400 13.5px/1.55 var(--inter)", color: "#52525B" }}>{st.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="v2-5" style={{ background: "#FAFAFA", padding: "clamp(70px,9vw,120px) clamp(20px,5vw,60px)" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", textAlign: "left" }}>
          <div style={{ maxWidth: 860, marginBottom: 46, textAlign: "left" }}>
            <div className="v2-font-heading" style={{ fontWeight: 800, fontSize: "clamp(64px,10vw,110px)", lineHeight: 0.85, color: "#E4E4E7", letterSpacing: "-.03em" }}>04</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 18 }}>
            {pillarsData.map((p) => (
              <div key={p.title} className="v2-card" style={{ background: "#FFFFFF", border: "1px solid #E4E4E7", borderRadius: 20, padding: "30px 28px" }}>
                <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 54, height: 54, borderRadius: 16, background: "#F4F4F5", color: "#CF4A2C" }}>
                  {p.icon}
                </span>
                <h3 className="v2-font-heading" style={{ margin: "18px 0 0", fontWeight: 700, fontSize: 19, letterSpacing: "-.01em", color: "#18181B" }}>{p.title}</h3>
                <p style={{ margin: "9px 0 0", font: "400 14.5px/1.6 var(--inter)", color: "#52525B" }}>{p.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="v2-6" style={{ position: "relative", padding: "clamp(80px,11vw,150px) clamp(20px,5vw,60px)", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 900, margin: "0 auto", textAlign: "left" }}>
          <div style={{ textAlign: "left", marginBottom: 44 }}>
            <div style={{ font: "700 12px/1 var(--inter)", letterSpacing: ".18em", textTransform: "uppercase", color: "#D4D4D8" }}>Our philosophy</div>
            <h2 className="v2-font-heading" style={{ margin: "12px 0 0", fontWeight: 700, fontSize: "clamp(32px,4.8vw,52px)", letterSpacing: "-.02em", color: "#FAFAFA" }}>
              We believe…
            </h2>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {beliefsData.map((b) => (
              <div key={b.n} style={{ display: "flex", alignItems: "center", gap: 16, padding: "20px 24px", background: "rgba(244,238,228,.06)", border: "1px solid rgba(244,238,228,.12)", borderRadius: 16, backdropFilter: "blur(4px)" }}>
                <span className="v2-font-heading" style={{ flex: "none", fontWeight: 700, fontSize: 18, color: "#CF4A2C", width: 30 }}>{b.n}</span>
                <p className="v2-font-heading" style={{ margin: 0, fontWeight: 500, fontSize: "clamp(17px,2.4vw,22px)", lineHeight: 1.35, letterSpacing: "-.01em", color: "#FAFAFA" }}>{b.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="v2-7" style={{ background: "#EFE7DA", padding: "clamp(70px,9vw,120px) clamp(20px,5vw,60px)" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", textAlign: "left" }}>
          <div style={{ maxWidth: 860, marginBottom: 32, textAlign: "left" }}>
            <div className="v2-font-heading" style={{ fontWeight: 800, fontSize: "clamp(64px,10vw,110px)", lineHeight: 0.85, color: "#E4E4E7", letterSpacing: "-.03em" }}>05</div>
          ...
          {hostsLoading ? (
            <div style={{ font: "500 16px var(--inter)", color: "#52525B", padding: "20px 0" }}>Loading verified hosts…</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 18 }}>
              {dynamicHosts.slice(0, 8).map((h) => {
                ...
                return (
                  <div key={h._id || name} className="v2-card" onClick={() => navigate(`/hosts/${slug}`)} style={{ background: "#FFFFFF", border: "1px solid #E4E4E7", borderRadius: 18, overflow: "hidden", cursor: "pointer" }}>
                    <div style={{ position: "relative" }}>
                      ...
                      <span className="v2-font-heading" style={{ position: "absolute", left: 14, bottom: -20, width: 52, height: 52, borderRadius: 14, background: "linear-gradient(150deg,#CF4A2C,#CF4A2C)", border: "3px solid #FFFFFF", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 20, color: "#FFFFFF", textAlign: "center", lineHeight: "46px" }}>
                        {initial}
                      </span>
                    </div>
                    <div style={{ padding: "28px 18px 20px" }}>
                      <div className="v2-font-heading" style={{ fontWeight: 700, fontSize: 17, color: "#18181B" }}>{name}</div>
                      <div style={{ marginTop: 3, font: "500 13px/1.3 var(--inter)", color: "#CF4A2C" }}>{title}</div>
                      <div style={{ marginTop: 10, display: "flex", alignItems: "center", gap: 6, font: "400 13px/1 var(--inter)", color: "#71717A" }}>
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#A1A1AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg> {loc}
                      </div>
                    </div>
                  </div>
                );
            ...
            <div style={{ font: "500 15px var(--inter)", color: "#52525B" }}>Discover our growing community of hosts across India.</div>
          )}
      ...
      <section id="v2-8" style={{ position: "relative", padding: "clamp(90px,12vw,170px) clamp(20px,5vw,60px)", overflow: "hidden", background: "#1a130d" }}>
        ...
        <div style={{ position: "relative", maxWidth: 840, margin: "0 auto", textAlign: "center" }}>
          <div style={{ font: "700 12px/1 var(--inter)", letterSpacing: ".16em", textTransform: "uppercase", color: "#D4D4D8" }}>Where we&apos;re heading</div>
          <h2 className="v2-font-heading" style={{ margin: "18px 0 0", fontWeight: 700, fontSize: "clamp(30px,5.4vw,56px)", lineHeight: 1.06, letterSpacing: "-.02em", color: "#FAFAFA" }}>
            We&apos;re building more than a travel platform.
          </h2>
          <p style={{ margin: "24px auto 0", maxWidth: 640, font: "400 clamp(16px,2vw,19px)/1.7 var(--inter)", color: "#A1A1AA" }}>
      ...
      {/* ===== 9 · BY THE NUMBERS ===== */}
      <section id="v2-9" style={{ background: "#FAFAFA", padding: "clamp(60px,9vw,110px) clamp(20px,5vw,60px)" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 44 }}>
            ...
            <h2 className="v2-font-heading" style={{ margin: "14px 0 0", fontWeight: 700, fontSize: "clamp(26px,4vw,40px)", letterSpacing: "-.02em", color: "#18181B" }}>
              A community just getting started
            </h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
            {numbersData.map((n) => (
              <div key={n.label} style={{ textAlign: "center", padding: "32px 20px", background: "#FFFFFF", border: "1px solid #E4E4E7", borderRadius: 18 }}>
                ...
                <div style={{ marginTop: 8, font: "600 13.5px/1.35 var(--inter)", color: "#3F3F46" }}>{n.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="v2-10" style={{ position: "relative", padding: "clamp(80px,11vw,150px) clamp(20px,5vw,60px)", background: "#CF4A2C", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 760, margin: "0 auto", textAlign: "center" }}>
          <h2 className="v2-font-heading" style={{ margin: 0, fontWeight: 700, fontSize: "clamp(32px,5.6vw,58px)", lineHeight: 1.04, letterSpacing: "-.02em", color: "#FFFFFF" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap", marginTop: 32 }}>
            <button type="button" onClick={() => navigate("/experiences")} style={{ padding: "15px 30px", font: "700 15px/1 var(--inter)", color: "#CF4A2C", background: "#FFFFFF", border: "none", borderRadius: 12, cursor: "pointer" }}>
              Explore experiences
            </button>
            <button type="button" className="v2-ghost" onClick={() => setOpenHostModal(true)} style={{ padding: "15px 30px", font: "700 15px/1 var(--inter)", color: "#FFFFFF", background: "transparent", border: "1.5px solid rgba(255,246,239,.5)", borderRadius: 12, cursor: "pointer" }}>
              Become a host
            </button>
          </div>
        </div>
