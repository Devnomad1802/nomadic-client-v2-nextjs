...
const array = [
  ...
  { value: "10", title: "Cancelled", info: "hlw", color: "#C8462A" },
];
      ...
      >
        ...
        >
          <Box>
            ...
            >
              <Typography
                sx={{ fontSize: { xs: "16px", md: "19px" }, color: "#4E483D" }}
              >
                John Deo
              </Typography>
              <Button
            ...
            <Typography sx={{ color: "#857C6C", mt: 1 }}>
          ...
          >
            MKNT10 <ContentCopyIcon sx={{ color: "#857C6C" }} />
          </Box>
        </Box>
        <Box
          sx={{
            border: "1px dashed #E1DACE",
            width: "100%",
            display: "flex",
            justifyContent: "space-between",
            alignItems: "start",
            ...
            return (
              ...
              >
                ...
                <Box sx={{ display: "flex", gap: "0px 10px", mt: 2 }}>
                  <Typography sx={{ color: "#6B6355" }}>
                    {item.title}
                  </Typography>
                  <InfoIcon sx={{ color: "#6B6355" }} />
                </Box>
              </Box>
            );
          })}
