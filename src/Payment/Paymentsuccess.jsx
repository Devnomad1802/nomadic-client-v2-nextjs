      ...
      <main className="ps2-main">
        ...
        <div className="ps2-hero">
          <div className="ps2-check">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#2E6E4E" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
          </div>
...
const css = `
.ps2{background:#F7F4EF;min-height:100vh;font-family:'Hanken Grotesk','Inter',system-ui,sans-serif}
...
.ps2-h1{margin:16px 0 0;font-family:'Bricolage Grotesque','Playfair Display',Georgia,serif;font-weight:700;font-size:clamp(26px,4.6vw,30px);letter-spacing:-.02em;color:#1E1C18}
.ps2-sub{margin:8px 0 0;font-size:15px;line-height:1.5;color:#6B6355}
...
.ps2-trip{margin:14px 0 0;font-family:'Bricolage Grotesque','Playfair Display',Georgia,serif;font-weight:700;font-size:clamp(23px,4vw,27px);line-height:1.06;letter-spacing:-.02em;color:#F7F4EF}
...
.ps2-stat-v{margin-top:5px;font-weight:600;font-size:14px;line-height:1.2;color:#F7F4EF}
.ps2-seam{position:relative;height:28px;background:#33312e}
.ps2-notch{position:absolute;top:0;width:28px;height:28px;border-radius:50%;background:#F7F4EF}
...
.ps2-stub{text-align:left;background:#EFEAE1;border:1px solid #EAD9C9;border-top:none;border-radius:0 0 20px 20px;padding:22px 30px}
.ps2-hostrow{display:flex;align-items:center;gap:14px;flex-wrap:wrap}
.ps2-host-av{width:54px;height:54px;border-radius:14px;background:linear-gradient(150deg,#D9714F,#C8462A);display:flex;align-items:center;justify-content:center;font-family:'Bricolage Grotesque',sans-serif;font-weight:700;font-size:21px;color:#FBF0EC}
.ps2-host-av--img{object-fit:cover}
.ps2-tick{position:absolute;right:-5px;bottom:-5px;width:20px;height:20px;border-radius:50%;background:#2E6E4E;border:2px solid #EFEAE1;display:flex;align-items:center;justify-content:center;color:#fff}
.ps2-hostedby{font-weight:600;font-size:10.5px;line-height:1;letter-spacing:.08em;text-transform:uppercase;color:#A79D8C}
.ps2-hostname{margin-top:4px;font-family:'Bricolage Grotesque','Playfair Display',Georgia,serif;font-weight:700;font-size:17px;color:#1E1C18}
.ps2-hostline{margin-top:2px;font-size:12px;line-height:1.4;color:#857C6C}
.ps2-msg{flex:none;padding:11px 18px;font-weight:700;font-size:13px;line-height:1;color:#fff;background:#C8462A;border:none;border-radius:10px;cursor:pointer}
...
.ps2-balance-t strong{color:#4E483D}
.ps2-paylink{font-weight:700;font-size:13px;line-height:1;color:#C8462A;cursor:pointer;white-space:nowrap}
.ps2-actions{display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-top:26px}
.ps2-primary{padding:14px;font-weight:700;font-size:14px;line-height:1;color:#fff;background:#C8462A;border:none;border-radius:12px;cursor:pointer}
.ps2-ghost{padding:14px;font-weight:700;font-size:14px;line-height:1;color:#1E1C18;background:#FFFFFF;border:1px solid #E1DACE;border-radius:12px;cursor:pointer}
.ps2-foot{margin:22px 0 0;text-align:center;font-size:12px;line-height:1.5;color:#857C6C}
...
.ps-ghost:hover{background:#EFEAE1;border-color:#C8462A}
